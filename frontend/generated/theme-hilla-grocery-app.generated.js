...
import stylesCss from 'themes/hilla-grocery-app/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_hilla-grocery-app_componentCss']) {
    
    document['_vaadintheme_hilla-grocery-app_componentCss'] = true;
  }
