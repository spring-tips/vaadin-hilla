    ...
    <div class='pad1'>
        ...
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>320/348</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>210/244</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>303/329</span>
            </div>
...
<a name='L914'></a><a href='#L914'>914</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">4044x</span>
<span class="cline-any cline-yes">108x</span>
<span class="cline-any cline-yes">108x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
function hasFontFamily(family) {
  if (!loadedFontFamilies) {
    ...
    for (let i = 0, ii = styleSheets.length; i &lt; ii; ++i) {
      const styleSheet = /** @type {CSSStyleSheet} */ (<span class="cstat-no" title="statement not covered" >styleSheets[i])</span>;
<span class="cstat-no" title="statement not covered" >      try {</span>
        const cssRules = <span class="cstat-no" title="statement not covered" >styleSheet.rules || styleSheet.cssRules;</span>
<span class="cstat-no" title="statement not covered" >        if (cssRules) {</span>
<span class="cstat-no" title="statement not covered" >          for (let j = <span class="cstat-no" title="statement not covered" >0,</span> jj = <span class="cstat-no" title="statement not covered" >cssRules.length;</span> j &lt; jj; ++j) {</span>
            const cssRule = <span class="cstat-no" title="statement not covered" >cssRules[j];</span>
<span class="cstat-no" title="statement not covered" >            if (cssRule.type == 5) {</span>
              const match = <span class="cstat-no" title="statement not covered" >cssRule.cssText.match(fontFamilyRegEx);</span>
<span class="cstat-no" title="statement not covered" >              loadedFontFamilies[match[1].replace(stripQuotesRegEx, '')] = true;</span>
            }
          }
        }
      } catch (e) {
...
function toSpriteUrl(url, path, extension) {
  ...
  return parts
    ? <span class="branch-0 cbranch-no" title="branch not covered" >parts[1] + extension + (parts.length &gt; 2 ? parts[2] : '')</span>
    : url + extension;
}
&nbsp;
/**
...
&nbsp;
    ...
    function onChange() {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!style &amp;&amp; (!glStyle.sprite || spriteData)) {
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!layer.getStyle()) {
<span class="cstat-no" title="statement not covered" >          reject(new Error(`Nothing to show for source [${source}]`));</span>
        } else {
          resolve();
        }
...
<span class="cstat-no" title="statement not covered" >        reject(new Error('Something went wrong trying to apply style.'));</span>
      }
    }
&nbsp;
    if (glStyle.sprite) {
...
function setBackground(mapOrLayer, layer) {
  ...
  function updateStyle(resolution) {
    ...
    const paint = layer.paint || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    ...
    const element =
      typeof mapOrLayer.getTargetElement === 'function'
        ...
        : undefined;
    let bg, opacity;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (paint['background-color'] !== undefined) {
      bg = getValue(
        background,
        'paint',
        'background-color',
  ...
  if (typeof mapOrLayer.getTargetElement === 'function') {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (mapOrLayer.getTargetElement()) {
      updateStyle();
    }
    mapOrLayer.on(['change:resolution', 'change:target'], updateStyle);
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof mapOrLayer.setBackground === 'function') {
    mapOrLayer.setBackground(updateStyle);
  } else {
<span class="cstat-no" title="statement not covered" >    throw new Error('Unable to apply background.');</span>
  }
}
&nbsp;
/**
...
export function applyBackground(mapOrLayer, glStyle) {
  glStyle.layers.some(function (l) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (l.type == 'background') {
    ...
    const key = tilejson.on('change', function () {
      ...
      if (state === 'ready') {
        ...
        const tiles = Array.isArray(tileJSONDoc.tiles)
          ? tileJSONDoc.tiles
          : <span class="branch-1 cbranch-no" title="branch not covered" >[tileJSONDoc.tiles];</span>
        if (url) {
...
function setupRasterLayer(glSource, url) {
  ...
  const key = source.on('change', function () {
    ...
    if (state === 'ready') {
      ...
      layer.setSource(source);
    } else <span class="missing-if-branch" title="if path not taken" >I</span>if (state === 'error') {
<span class="cstat-no" title="statement not covered" >      unByKey(key);</span>
<span class="cstat-no" title="statement not covered" >      layer.setSource(undefined);</span>
    }
  });
  source.setTileLoadFunction(<span class="fstat-no" title="function not covered" >fu</span>nction (tile, src) {
<span class="cstat-no" title="statement not covered" >    if (src.indexOf('{bbox-epsg-3857}') != -1) {</span>
      const bbox = <span class="cstat-no" title="statement not covered" >source.getTileGrid().getTileCoordExtent(tile.getTileCoord());</span>
<span class="cstat-no" title="statement not covered" >      src = src.replace('{bbox-epsg-3857}', bbox.toString());</span>
    }
    const img = /** @type {import("ol/ImageTile").default} */ <span class="cstat-no" title="statement not covered" >(tile).getImage();</span>
    /** @type {HTMLImageElement} */ <span class="cstat-no" title="statement not covered" >(img).src = src;</span>
  });
  return layer;
}
&nbsp;
...
function processStyle(glStyle, map, baseUrl, host, path, accessToken = '') {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (
    typeof view.options_ === 'object'
      ? <span class="branch-0 cbranch-no" title="branch not covered" >isEmpty(view.options_)</span>
...
&nbsp;
  ...
  if (glStyle.sprite) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (glStyle.sprite.indexOf('mapbox://') == 0) {
<span class="cstat-no" title="statement not covered" >      glStyle.sprite = baseUrl + '/sprite' + accessToken;</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (glStyle.sprite.indexOf('http') != 0) {
...
&nbsp;
  ...
  for (let i = 0, ii = glLayers.length; i &lt; ii; ++i) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (type == 'heatmap' || type == 'hillshade') {
          ...
          if (url.indexOf('mapbox://') == 0) {
            ...
            glSource.tiles = ['a', 'b', 'c', 'd'].map(function (host) {
              return (
                ...
                mapid +
                '/{z}/{x}/{y}.' +
                (glSource.type == 'vector' ? 'vector.pbf' : <span class="branch-1 cbranch-no" title="branch not covered" >'png')</span> +
                accessToken
              );
            });
...
&nbsp;
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (glSource.type == 'geojson') {
          layer = setupGeoJSONLayer(glSource, path);
        }
        glSourceId = id;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (layer) {
...
<span class="cstat-no" title="statement not covered" >      baseUrl = parts[1];</span>
<span class="cstat-no" title="statement not covered" >      accessToken = parts.length &gt; 2 ? parts[2] : '';</span>
    }
...
<span class="cstat-no" title="statement not covered" >          reject(new Error(`Could not load ${style}: ${err.message}`));</span>
        });
    });
  } else {
    promise = new Promise(function (resolve, reject) {
...
export function getLayer(map, layerId) {
  ...
  for (let i = 0, ii = layers.length; i &lt; ii; ++i) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (mapboxLayers &amp;&amp; mapboxLayers.indexOf(layerId) !== -1) {
