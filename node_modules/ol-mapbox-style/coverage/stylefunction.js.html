...
<head>
    <title>Code coverage report for stylefunction.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> stylefunction.js</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">66.23% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>255/385</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>179/293</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                <span class="strong">66.05% </span>
                <span class="quiet">Lines</span>
                <span class='fraction'>251/380</span>
            </div>
...
<a name='L1214'></a><a href='#L1214'>1214</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1586x</span>
<span class="cline-any cline-yes">1586x</span>
...
const expressionData = function (rawExpression, propertySpec) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (compiledExpression.result === 'error') {
<span class="cstat-no" title="statement not covered" >    throw new Error(</span>
      compiledExpression.value
        .map(<span class="fstat-no" title="function not covered" >(e</span>rr) =&gt; <span class="cstat-no" title="statement not covered" >`${err.key}: ${err.message}`)</span>
        .join(', ')
    );
  }
...
function evaluateFilter(layerId, filter, feature, zoom, filterCache) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!filterCache) {
<span class="cstat-no" title="statement not covered" >    console.warn('No filterCache provided to evaluateFilter()'); </span>//eslint-disable-line no-console
  }
...
export default function (
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof glStyle == 'string') {
<span class="cstat-no" title="statement not covered" >    glStyle = JSON.parse(glStyle);</span>
  }
  <span class="missing-if-branch" title="if path not taken" >I</span>if (glStyle.version != 8) {
<span class="cstat-no" title="statement not covered" >    throw new Error('glStyle version 8 required.');</span>
  }
&nbsp;
  let spriteImage, spriteImgSize;
  if (spriteImageUrl) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof Image !== 'undefined') {
      const img = new Image();
    ...
    } else <span class="cstat-no" title="statement not covered" >if (typeof WorkerGlobalScope !== 'undefined' &amp;&amp; self instanceof WorkerGlobalScope) { //eslint-disable-line</span>
      const worker = /** @type {*} */ (<span class="cstat-no" title="statement not covered" >self)</span>;
      // Main thread needs to handle 'loadImage' and dispatch 'imageLoaded'
<span class="cstat-no" title="statement not covered" >      worker.postMessage({</span>
        action: 'loadImage',
        src: spriteImageUrl,
      });
<span class="cstat-no" title="statement not covered" >      worker.addEventListener('message', function <span class="fstat-no" title="function not covered" >handler(</span>event) {</span>
<span class="cstat-no" title="statement not covered" >        if (</span>
          event.data.action === 'imageLoaded' &amp;&amp;
          event.data.src === spriteImageUrl
        ) {
<span class="cstat-no" title="statement not covered" >          spriteImage = event.data.image;</span>
<span class="cstat-no" title="statement not covered" >          spriteImgSize = [spriteImage.width, spriteImage.height];</span>
        }
      });
    }
  }
...
<span class="cstat-no" title="statement not covered" >          throw new Error(`Source "${mapboxSource}" is not defined`);</span>
        }
...
&nbsp;
  const styleFunction = function (feature, resolution) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!layers) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
    let zoom = resolutions.indexOf(resolution);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (zoom == -1) {
...
&nbsp;
      ...
      if (!filter || evaluateFilter(layerId, filter, f, zoom, filterCache)) {
        ...
        if (
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (layer.type + '-pattern' in paint) {
            const fillIcon = <span class="cstat-no" title="statement not covered" >getValue(</span>
              layer,
              'paint',
              layer.type + '-pattern',
              zoom,
...
<span class="cstat-no" title="statement not covered" >            if (fillIcon) {</span>
              const icon =
<span class="cstat-no" title="statement not covered" >                typeof fillIcon === 'string'</span>
                  ? fromTemplate(fillIcon, properties)
                  : fillIcon.toString();
<span class="cstat-no" title="statement not covered" >              if (spriteImage &amp;&amp; spriteData &amp;&amp; spriteData[icon]) {</span>
<span class="cstat-no" title="statement not covered" >                ++stylesLength;</span>
<span class="cstat-no" title="statement not covered" >                style = styles[stylesLength];</span>
<span class="cstat-no" title="statement not covered" >                if (</span>
                  !style ||
                  !style.getFill() ||
                  style.getStroke() ||
...
<span class="cstat-no" title="statement not covered" >                  style = new Style({</span>
                    fill: new Fill(),
                  });
<span class="cstat-no" title="statement not covered" >                  styles[stylesLength] = style;</span>
                }
<span class="cstat-no" title="statement not covered" >                fill = style.getFill();</span>
<span class="cstat-no" title="statement not covered" >                style.setZIndex(index);</span>
                const icon_cache_key = <span class="cstat-no" title="statement not covered" >icon + '.' + opacity;</span>
                let pattern = <span class="cstat-no" title="statement not covered" >patternCache[icon_cache_key];</span>
<span class="cstat-no" title="statement not covered" >                if (!pattern) {</span>
                  const spriteImageData = <span class="cstat-no" title="statement not covered" >spriteData[icon];</span>
                  const canvas = <span class="cstat-no" title="statement not covered" >createCanvas(</span>
                    spriteImageData.width,
                    spriteImageData.height
                  );
                  const ctx = /** @type {CanvasRenderingContext2D} */ (
<span class="cstat-no" title="statement not covered" >                    canvas.getContext('2d')</span>
                  );
<span class="cstat-no" title="statement not covered" >                  ctx.globalAlpha = opacity;</span>
<span class="cstat-no" title="statement not covered" >                  ctx.drawImage(</span>
                    spriteImage,
                    spriteImageData.x,
                    spriteImageData.y,
                    spriteImageData.width,
...
<span class="cstat-no" title="statement not covered" >                  pattern = ctx.createPattern(canvas, 'repeat');</span>
<span class="cstat-no" title="statement not covered" >                  patternCache[icon_cache_key] = pattern;</span>
                }
<span class="cstat-no" title="statement not covered" >                fill.setColor(pattern);</span>
              }
            }
          } else {
            ...
            if (color || strokeColor) {
              ...
              if (
                !style ||
                (color &amp;&amp; !style.getFill()) ||
                (!color &amp;&amp; <span class="branch-4 cbranch-no" title="branch not covered" >style.getFill())</span> ||
                (strokeColor &amp;&amp; !style.getStroke()) ||
                (!strokeColor &amp;&amp; <span class="branch-8 cbranch-no" title="branch not covered" >style.getStroke())</span> ||
                style.getText()
              ) {
                style = new Style({
                  fill: color ? new Fill() : undefined,
                  stroke: strokeColor ? new Stroke() : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
                });
              ...
              <span class="missing-if-branch" title="else path not taken" >E</span>if (strokeColor) {
        ...
        if (type != 1 &amp;&amp; layer.type == 'line') {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (color &amp;&amp; width &gt; 0) {
            ++stylesLength;
            style = styles[stylesLength];
            if (
              !style ||
            ...
            stroke.setLineDash(
              paint['line-dasharray']
                ? <span class="branch-0 cbranch-no" title="branch not covered" >getValue(</span>
                    layer,
                    'paint',
                    'line-dasharray',
                    zoom,
                    f,
                    functionCache
                  ).map(<span class="fstat-no" title="function not covered" >fu</span>nction (x) {
<span class="cstat-no" title="statement not covered" >                    return x * width;</span>
                  })
                : null
            );
            style.setZIndex(index);
...
&nbsp;
        ...
        if ((type == 1 || type == 2) &amp;&amp; 'icon-image' in layout) {
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (iconImage) {
            icon =
              typeof iconImage === 'string'
                ? fromTemplate(iconImage, properties)
                : <span class="branch-1 cbranch-no" title="branch not covered" >iconImage.toString();</span>
            ...
            if (spriteImage &amp;&amp; spriteData &amp;&amp; spriteData[icon]) {
              ...
              <span class="missing-if-branch" title="if path not taken" >I</span>if (type == 2) {
                const geom = <span class="cstat-no" title="statement not covered" >feature.getGeometry();</span>
                // ol package and ol-debug.js only
<span class="cstat-no" title="statement not covered" >                if (geom.getFlatMidpoint || geom.getFlatMidpoints) {</span>
                  const extent = <span class="cstat-no" title="statement not covered" >geom.getExtent();</span>
                  const size = <span class="cstat-no" title="statement not covered" >Math.sqrt(</span>
                    Math.max(
                      Math.pow((extent[2] - extent[0]) / resolution, 2),
                      Math.pow((extent[3] - extent[1]) / resolution, 2)
                    )
                  );
<span class="cstat-no" title="statement not covered" >                  if (size &gt; 150) {</span>
                    //FIXME Do not hard-code a size of 150
                    const midpoint =
<span class="cstat-no" title="statement not covered" >                      geom.getType() === 'MultiLineString'</span>
                        ? geom.getFlatMidpoints()
                        : geom.getFlatMidpoint();
<span class="cstat-no" title="statement not covered" >                    if (!renderFeature) {</span>
<span class="cstat-no" title="statement not covered" >                      renderFeatureCoordinates = [NaN, NaN];</span>
<span class="cstat-no" title="statement not covered" >                      renderFeature = new RenderFeature(</span>
                        'Point',
...
<span class="cstat-no" title="statement not covered" >                    styleGeom = renderFeature;</span>
<span class="cstat-no" title="statement not covered" >                    renderFeatureCoordinates[0] = midpoint[0];</span>
<span class="cstat-no" title="statement not covered" >                    renderFeatureCoordinates[1] = midpoint[1];</span>
                    const placement = <span class="cstat-no" title="statement not covered" >getValue(</span>
                      layer,
                      'layout',
                      'symbol-placement',
                      zoom,
...
<span class="cstat-no" title="statement not covered" >                    if (</span>
                      ...
                      const stride = <span class="cstat-no" title="statement not covered" >geom.getStride();</span>
                      const coordinates = <span class="cstat-no" title="statement not covered" >geom.getFlatCoordinates();</span>
<span class="cstat-no" title="statement not covered" >                      for (</span>
                        let i = <span class="cstat-no" title="statement not covered" >0,</span> ii = <span class="cstat-no" title="statement not covered" >coordinates.length - stride;</span>
                        i &lt; ii;
                        i += stride
                      ) {
                        const x1 = <span class="cstat-no" title="statement not covered" >coordinates[i];</span>
                        const y1 = <span class="cstat-no" title="statement not covered" >coordinates[i + 1];</span>
                        const x2 = <span class="cstat-no" title="statement not covered" >coordinates[i + stride];</span>
                        const y2 = <span class="cstat-no" title="statement not covered" >coordinates[i + stride + 1];</span>
                        const minX = <span class="cstat-no" title="statement not covered" >Math.min(x1, x2);</span>
                        const minY = <span class="cstat-no" title="statement not covered" >Math.min(y1, y2);</span>
                        const maxX = <span class="cstat-no" title="statement not covered" >Math.max(x1, x2);</span>
                        const maxY = <span class="cstat-no" title="statement not covered" >Math.max(y1, y2);</span>
<span class="cstat-no" title="statement not covered" >                        if (</span>
                          midpoint[0] &gt;= minX &amp;&amp;
                          midpoint[0] &lt;= maxX &amp;&amp;
                          midpoint[1] &gt;= minY &amp;&amp;
...
<span class="cstat-no" title="statement not covered" >                          placementAngle = Math.atan2(y1 - y2, x2 - x1);</span>
<span class="cstat-no" title="statement not covered" >                          break;</span>
              ...
              <span class="missing-if-branch" title="else path not taken" >E</span>if (type !== 2 || <span class="branch-1 cbranch-no" title="branch not covered" >styleGeom)</span> {
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (!iconColor || iconColor.a !== 0) {
                  let icon_cache_key = <span class="cstat-no" title="statement not covered" >icon + '.' + iconSize;</span>
<span class="cstat-no" title="statement not covered" >                  if (iconColor !== null) {</span>
<span class="cstat-no" title="statement not covered" >                    icon_cache_key += '.' + iconColor;</span>
                  }
<span class="cstat-no" title="statement not covered" >                  iconImg = iconImageCache[icon_cache_key];</span>
<span class="cstat-no" title="statement not covered" >                  if (!iconImg) {</span>
                    const spriteImageData = <span class="cstat-no" title="statement not covered" >spriteData[icon];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    iconImg = new Icon({</span>
                      color: iconColor
                        ? [
                            iconColor.r * 255,
                            iconColor.g * 255,
...
<span class="cstat-no" title="statement not covered" >                    iconImageCache[icon_cache_key] = iconImg;</span>
                  }
                }
                <span class="missing-if-branch" title="if path not taken" >I</span>if (iconImg) {
<span class="cstat-no" title="statement not covered" >                  ++stylesLength;</span>
<span class="cstat-no" title="statement not covered" >                  style = styles[stylesLength];</span>
<span class="cstat-no" title="statement not covered" >                  if (</span>
                    !style ||
...
<span class="cstat-no" title="statement not covered" >                  style.setGeometry(styleGeom);</span>
<span class="cstat-no" title="statement not covered" >                  iconImg.setRotation(</span>
                    placementAngle +
                      deg2rad(
                        getValue(
                          layer,
...
<span class="cstat-no" title="statement not covered" >                  iconImg.setOpacity(</span>
                    getValue(
                      layer,
                      'paint',
                      'icon-opacity',
...
<span class="cstat-no" title="statement not covered" >                  iconImg.setAnchor(</span>
                    anchor[
                      getValue(
                        layer,
                        'layout',
...
<span class="cstat-no" title="statement not covered" >                  style.setImage(iconImg);</span>
<span class="cstat-no" title="statement not covered" >                  text = style.getText();</span>
<span class="cstat-no" title="statement not covered" >                  style.setText(undefined);</span>
<span class="cstat-no" title="statement not covered" >                  style.setZIndex(index);</span>
<span class="cstat-no" title="statement not covered" >                  hasImage = true;</span>
<span class="cstat-no" title="statement not covered" >                  skipLabel = false;</span>
                }
              } else {
<span class="cstat-no" title="statement not covered" >                skipLabel = true;</span>
              }
            }
          }
        }
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (type == 1 &amp;&amp; 'circle-radius' in paint) {
<span class="cstat-no" title="statement not covered" >          ++stylesLength;</span>
<span class="cstat-no" title="statement not covered" >          style = styles[stylesLength];</span>
<span class="cstat-no" title="statement not covered" >          if (</span>
            !style ||
...
<span class="cstat-no" title="statement not covered" >            styles[stylesLength] = style;</span>
          ...
          const circleRadius = <span class="cstat-no" title="statement not covered" >getValue(</span>
            layer,
            'paint',
            'circle-radius',
            zoom,
          ...
          const circleStrokeColor = <span class="cstat-no" title="statement not covered" >colorWithOpacity(</span>
            getValue(
              layer,
              'paint',
              'circle-stroke-color',
          ...
          const circleColor = <span class="cstat-no" title="statement not covered" >colorWithOpacity(</span>
            getValue(layer, 'paint', 'circle-color', zoom, f, functionCache),
            getValue(layer, 'paint', 'circle-opacity', zoom, f, functionCache)
          );
          const circleStrokeWidth = <span class="cstat-no" title="statement not covered" >getValue(</span>
            layer,
            'paint',
            'circle-stroke-width',
            zoom,
          ...
          const cache_key =
<span class="cstat-no" title="statement not covered" >            circleRadius +</span>
            '.' +
            circleStrokeColor +
            '.' +
            circleColor +
            '.' +
            circleStrokeWidth;
<span class="cstat-no" title="statement not covered" >          iconImg = iconImageCache[cache_key];</span>
<span class="cstat-no" title="statement not covered" >          if (!iconImg) {</span>
<span class="cstat-no" title="statement not covered" >            iconImg = new Circle({</span>
              radius: circleRadius,
              stroke:
...
<span class="cstat-no" title="statement not covered" >            iconImageCache[cache_key] = iconImg;</span>
          }
<span class="cstat-no" title="statement not covered" >          style.setImage(iconImg);</span>
<span class="cstat-no" title="statement not covered" >          text = style.getText();</span>
<span class="cstat-no" title="statement not covered" >          style.setText(undefined);</span>
<span class="cstat-no" title="statement not covered" >          style.setGeometry(undefined);</span>
<span class="cstat-no" title="statement not covered" >          style.setZIndex(index);</span>
<span class="cstat-no" title="statement not covered" >          hasImage = true;</span>
        }
&nbsp;
        ...
        if (label &amp;&amp; opacity &amp;&amp; !skipLabel) {
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!hasImage) {
            ++stylesLength;
            style = styles[stylesLength];
            <span class="missing-if-branch" title="else path not taken" >E</span>if (
              !style ||
<span class="branch-1 cbranch-no" title="branch not covered" >              !style.getText() </span>||
<span class="branch-2 cbranch-no" title="branch not covered" >              style.getFill() </span>||
<span class="branch-3 cbranch-no" title="branch not covered" >              style.getStroke()</span>
            ) {
              style = new Style();
              styles[stylesLength] = style;
            }
          ...
          <span class="missing-if-branch" title="else path not taken" >E</span>if (!style.getText()) {
            style.setText(
              text ||
                new Text({
                  padding: [2, 2, 2, 2],
          ...
          const font = mb2css(
            getFonts ? getFonts(fontArray) : <span class="branch-1 cbranch-no" title="branch not covered" >fontArray,</span>
            textSize,
            textLineHeight
          );
          const textTransform = layout['text-transform'];
          <span class="missing-if-branch" title="if path not taken" >I</span>if (textTransform == 'uppercase') {
<span class="cstat-no" title="statement not covered" >            label = label.toUpperCase();</span>
          } else <span class="missing-if-branch" title="if path not taken" >I</span>if (textTransform == 'lowercase') {
<span class="cstat-no" title="statement not covered" >            label = label.toLowerCase();</span>
          }
          ...
          if (placement == 'point') {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (textAnchor.indexOf('left') !== -1) {
<span class="cstat-no" title="statement not covered" >              textAlign = 'left';</span>
<span class="cstat-no" title="statement not covered" >              hOffset = textHaloWidth;</span>
            } else <span class="missing-if-branch" title="if path not taken" >I</span>if (textAnchor.indexOf('right') !== -1) {
<span class="cstat-no" title="statement not covered" >              textAlign = 'right';</span>
<span class="cstat-no" title="statement not covered" >              hOffset = -textHaloWidth;</span>
            }
          ...
          } else <span class="missing-if-branch" title="if path not taken" >I</span>if (textAnchor.indexOf('top') == 0) {
<span class="cstat-no" title="statement not covered" >            textBaseline = 'top';</span>
<span class="cstat-no" title="statement not covered" >            vOffset = textHaloWidth + 0.5 * (textLineHeight - 1) * textSize;</span>
          }
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (haloColor) {
<span class="cstat-no" title="statement not covered" >            textHalo.setColor(haloColor);</span>
            // spec here : https://docs.mapbox.com/mapbox-gl-js/style-spec/#paint-symbol-text-halo-width
            // Halo width must be doubled because it is applied around the center of the text outline
<span class="cstat-no" title="statement not covered" >            textHaloWidth *= 2;</span>
            // 1/4 of text size (spec) x 2
            const halfTextSize = <span class="cstat-no" title="statement not covered" >0.5 * textSize;</span>
<span class="cstat-no" title="statement not covered" >            textHalo.setWidth(</span>
              textHaloWidth &lt;= halfTextSize ? textHaloWidth : halfTextSize
            );
<span class="cstat-no" title="statement not covered" >            text.setStroke(textHalo);</span>
          } else {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (textPadding !== padding[0]) {
<span class="cstat-no" title="statement not covered" >            padding[0] = textPadding;</span>
<span class="cstat-no" title="statement not covered" >            padding[1] = textPadding;</span>
<span class="cstat-no" title="statement not covered" >            padding[2] = textPadding;</span>
<span class="cstat-no" title="statement not covered" >            padding[3] = textPadding;</span>
          }
          style.setZIndex(index);
        }
      }
...
&nbsp;
    if (stylesLength &gt; -1) {
      ...
      if (recordLayer) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof feature.set === 'function') {
          // ol/Feature
          feature.set('mapbox-layer', featureBelongsToLayer);
        } else {
          // ol/render/Feature
<span class="cstat-no" title="statement not covered" >          feature.getProperties()['mapbox-layer'] = featureBelongsToLayer;</span>
        }
      }
      return styles;
    }
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Jan 24 2022 19:25:58 GMT+0100 (Central European Standard Time)
            </div>
        </div>
